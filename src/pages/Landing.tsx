      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-blue-200 mb-10 max-w-3xl mx-auto">
            Build powerful checkout experiences with A/B testing, affiliate management,
            sales funnels, and comprehensive analytics all in one platform.
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-20">
          <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8 hover:bg-white/10 transition-all">
            ...
            <p className="text-blue-200">
              Build beautiful, conversion-optimized checkout pages with our template library.
          ...
          <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8 hover:bg-white/10 transition-all">
            ...
            <p className="text-blue-200">
              Optimize conversion rates with built-in A/B testing. Test different layouts,
              copy, and pricing strategies effortlessly.
            </p>
          </div>
          ...
          <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8 hover:bg-white/10 transition-all">
            ...
            <p className="text-blue-200">
              Manage your entire affiliate program with commission tracking, payouts,
          ...
          <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8 hover:bg-white/10 transition-all">
            ...
            <p className="text-blue-200">
              Create multi-step funnels with upsells, downsells, and order bumps to
          ...
          <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8 hover:bg-white/10 transition-all">
            ...
            <p className="text-blue-200">
              Built with security in mind. PCI compliant with secure payment processing
              and data encryption.
            </p>
          </div>
          ...
          <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8 hover:bg-white/10 transition-all">
            ...
            <p className="text-blue-200">
              Complete REST API with 37+ endpoints. Build custom integrations and
